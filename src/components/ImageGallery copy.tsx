...
const ImageGallery: React.FC = () => {
  ...
  const [imageWidth, setImageWidth] = useState('79.2vw');
  ...
  useEffect(() => {
    const updateImageWidth = () => {
      ...
      if (viewportWidth < 768) {
        console.log('viewportWidth 40vh ?',viewportWidth)
        // Mobile view: width is 40vh
        setImageWidth('40vh');
      } else if (viewportWidth >= 768 && viewportWidth < 1024) {
        console.log('viewportWidth 50vh ?',viewportWidth)
        // Tablet view: width is 50vh
        setImageWidth('50vh');
      } else {
        // Default view: width is 79.2vw
        console.log('viewportWidth',viewportWidth)
        setImageWidth('79.2vw');
      }
    };
    ...
    // Run once to set initial image width
    updateImageWidth();
          ...
          <div className="relative h-full">
            ...
            >
              <img 
                ...
                alt="Styled view"
                className="absolute inset-0 w-full h-full object-cover"
                // style={{ maxWidth: 'none' ,width: imageWidth}}
              />
            </div>
